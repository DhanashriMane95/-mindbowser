...
const Home = () => {
    ...
    console.log(color)
    sessionStorage.setItem('BookmarkData', JSON.stringify(bookmarkData));
                        ...
                        paginated?.length ? paginated.map((items, index) => {
                            return (
                                <>
                                    ...
                                    <div className="col-md-4 col-12 d-flex justify-content-around" type="button" style={{ width: "26rem" }}>
