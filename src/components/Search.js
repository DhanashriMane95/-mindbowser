...
const Search = (props) => {
   let searchedPostData = localStorage.getItem("searchedPostData");
    let data = JSON.parse(searchedPostData);    
  return (
    <>
                        ...
                        data?.length ? data.map((items, index) => {
                            return (
                                <>
                                    ...
                                    <div key={index} className="col-md-4 col-12 d-flex justify-content-around" type="button" style={{width:"26rem"}}  >
